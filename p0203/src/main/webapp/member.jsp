	...
	<form action="./doMember.jsp" method="post" name="frm">
      <table>
        <tr>
          ...
          <td>
            <div class="id-check-box">
              <input name="id" type="text" placeholder="영문소문자/숫자, 4~16자">
        ...
        <tr>
          ...
          <td><input name="pw" type="password" placeholder="영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 10자~16자"></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input name="nickname" type="text" placeholder="사용할 닉네임 입력"></td>
        </tr>
        <tr>
